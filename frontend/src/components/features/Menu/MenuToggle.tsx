...
export const MenuToggle: React.FC<MenuToggleProps> = ({ showTextState, onToggle }) => {
    ...
    useEffect(() => {
        if (checkboxRef.current) {
            checkboxRef.current.indeterminate = showTextState === ShowTextState.SHOW_ONLY_TRANSLATION;
        }
    }, [showTextState]);
    return (
