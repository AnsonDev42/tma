...
class Settings(BaseSettings):
    ...
    MENU_LAYOUT_WASH_TIMEOUT_SECONDS: int = 25
    MENU_LAYOUT_ENABLE_HEURISTIC_FALLBACK: bool = False
    MENU_DISH_INFO_LLM_MODEL: str = "gpt-5-mini"
    MENU_DISH_INFO_LLM_TEMPERATURE: float = 0
