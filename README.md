...
1. Github Action triggers a /GET request to `https://pipeline.itsya0wen.com` to notify eq server to check updates with dockerhub using watchtower and pull the latest image.
